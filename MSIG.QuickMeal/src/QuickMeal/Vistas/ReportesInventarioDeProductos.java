 ...
 * @author Derwin
 */
public class ReportesInventarioDeProductos extends javax.swing.JInternalFrame {

    Mensaje mensaje = new Mensaje();
    /**
     * Creates new form ReportesInventarioDeProductos
     */
    public ReportesInventarioDeProductos() {
        initComponents();
    }
    ...
    private void btnGenerarReporteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGenerarReporteActionPerformed
        try{
            ...
            URL url_reporte = this.getClass().getResource("/QuickMeal/Reportes/InventarioDeProductos.jasper");
            JasperReport reporte = (JasperReport) JRLoader.loadObject(url_reporte);
            JasperPrint pantalla = JasperFillManager.fillReport(reporte, null, acceso.conectar());
