 ...
 * @author Derwin
 */
public class ReportesIngredientesUtilizadosFecha extends javax.swing.JInternalFrame {

    Mensaje mensaje = new Mensaje();
    /**
     * Creates new form ReportesHistorialComprasPorFecha
     */
    public ReportesIngredientesUtilizadosFecha() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        lblTitulo.setText("Ingredientes Utilizados x Fecha");
    ...
    private void btnGenerarReporteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGenerarReporteActionPerformed
        try {
            ...
            URL url_reporte = this.getClass().getResource("/QuickMeal/Reportes/IngredientesUtilizadosPorFecha.jasper");
