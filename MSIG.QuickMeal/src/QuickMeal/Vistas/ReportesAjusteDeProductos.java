 ...
 * @author Derwin
 */
public class ReportesAjusteDeProductos extends javax.swing.JInternalFrame {

    /**
     * Creates new form ReportesHistorialComprasPorFecha
     */
    public ReportesAjusteDeProductos() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        lblFechaInicial1.setText("ID Producto");
    ...
    private void btnGenerarReporteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGenerarReporteActionPerformed
        ...
        try {
            ...
            URL url_reporte = this.getClass().getResource("/QuickMeal/Reportes/AjusteDeProductos.jasper");
            JasperReport reporte = (JasperReport) JRLoader.loadObject(url_reporte);
            HashMap parametro = new HashMap();
            if(txtIdProducto.getText().isEmpty()) {
                parametro.put("P_ID_PRODUCTO", null);
            } else {
                parametro.put("P_ID_PRODUCTO", Integer.parseInt(txtIdProducto.getText()));
            }
