 ...
 * @author Derwin
 */
public class ReportesPlanillaEmpleados extends javax.swing.JInternalFrame {

    Mensaje mensaje = new Mensaje();
    /**
     * Creates new form ReportesHistorialComprasPorFecha
     */
    public ReportesPlanillaEmpleados() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        lblTitulo.setText("PLanilla de Empleados");
    ...
    private void btnGenerarReporteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGenerarReporteActionPerformed
        try {
            ...
            URL url_reporte = this.getClass().getResource("/QuickMeal/Reportes/PlanillaBonificacion.jasper");
            ...
            parametro.put("P_CANTIDAD", Integer.parseInt(txtCantidad.getText()));
