 ...
 * @author Derwin
 */
public class ReportesVentasPorClienteConsolidado extends javax.swing.JInternalFrame {

    Mensaje mensaje = new Mensaje();
    /**
     * Creates new form ReportesHistorialComprasPorFecha
     */
    public ReportesVentasPorClienteConsolidado() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        lblTitulo.setText("Ventas por Cliete Consolidado");
        ...
        cbxFormaPago.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Credito", "Efectivo", "Cheque", "Tarjeta", "Todos" }));
            ...
            .addGroup(pnlParametrosLayout.createSequentialGroup()
                ...
                .addGroup(pnlParametrosLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(pnlParametrosLayout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addGroup(pnlParametrosLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(cbxFormaPago, javax.swing.GroupLayout.Alignment.TRAILING, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
    ...
    private void btnGenerarReporteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGenerarReporteActionPerformed
        try {
            ...
            URL url_reporte = this.getClass().getResource("/QuickMeal/Reportes/VentasPorClienteConsolidado.jasper");
            ...
            if(cbxFormaPago.getSelectedItem().toString().equals("Todos")){
                parametro.put("P_TIPO", null);
            } else {
