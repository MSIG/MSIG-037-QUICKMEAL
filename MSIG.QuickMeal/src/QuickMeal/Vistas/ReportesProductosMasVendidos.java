 ...
 * @author Derwin
 */
public class ReportesProductosMasVendidos extends javax.swing.JInternalFrame {

    Mensaje mensaje = new Mensaje();
    /**
     * Creates new form ReportesInventarioDeProductos
     */
    public ReportesProductosMasVendidos() {
        initComponents();
    }
    ...
    private void btnGenerarReporteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGenerarReporteActionPerformed
        try{
            ...
            URL url_reporte = this.getClass().getResource("/QuickMeal/Reportes/ProductoMasVendido.jasper");
