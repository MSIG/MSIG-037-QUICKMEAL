 ...
 * @author Derwin
 */
public class ReportesHisComprasClienteDetallado extends javax.swing.JInternalFrame {

    Mensaje mensaje = new Mensaje();
    /**
     * Creates new form ReportesHistorialComprasPorFecha
     */
    public ReportesHisComprasClienteDetallado() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        lblTitulo.setText("Ventas por Cliente Detallado");
    ...
    private void btnGenerarReporteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGenerarReporteActionPerformed
        try {
            ...
            //VALIDAR EL EL DATO ES NULO
            if(txtCodigo.getText().equals("")) {
                parametro.put("P_CODIGO_CLIENTE", null);
            } else {
                parametro.put("P_CODIGO_CLIENTE", Integer.parseInt(txtCodigo.getText()));
            }
