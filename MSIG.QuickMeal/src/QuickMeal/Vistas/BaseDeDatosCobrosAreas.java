...
import QuickMeal.Accesos.AccesoReporteAreas;
...
public class BaseDeDatosCobrosAreas extends javax.swing.JInternalFrame {

    AccesoReporteAreas acceso = new AccesoReporteAreas();
    ArrayList<ObjetoReporteAreas> lista = new ArrayList();
    Mensaje mensaje = new Mensaje();
    
    /**
     * Creates new form wdwBaseDeDAtosHistorialDeVentas
     */
    public BaseDeDatosCobrosAreas() {
        initComponents();
    }
    ...
    private void mostrarOrdenes(String inicio, String fin){
        ...
        for(ObjetoReporteAreas n : lista){
            tabla.setValueAt(n.getDescripcion(), i, 0);
            tabla.setValueAt(n.getCentro_costo(), i, 1);
            tabla.setValueAt(n.getCuenta(), i, 2);
            tabla.setValueAt(n.getTotal(), i, 3);
            i++;
        }
